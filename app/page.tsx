    ...
    <div className="max-w-lg mx-auto bg-white min-h-screen pb-16">
      ...
      <div className="sticky top-0 z-20 bg-white border-b">
        <div className="flex items-center justify-between p-3 max-w-lg mx-auto">
          ...
          <a href="https://m.we88z.com/register/"><Button className="bg-[#056449] rounded-full hover:bg-[#056449] text-sm px-6">{t("common.download")}</Button></a>
        </div>
      </div>
      {/* Header */}
      <header className="flex items-center justify-between p-4 top-[64px] bg-white z-10">
      <a href="https://m.we88z.com/">
...
{/* 
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t">
        <nav className="flex justify-around items-center h-16 max-w-lg mx-auto px-4">
          <a href="https://m.we88z.com/th/login" className="flex flex-col items-center gap-1">
            <GamepadIcon className="h-6 w-6 text-gray-600" />
            <span className="text-xs">{t("navigation.games")}</span>
          </a>
          <a href="https://m.we88z.com/th/register" className="flex flex-col items-center gap-1">
          ...
          <a href="https://m.we88z.com" className="flex flex-col items-center gap-1">
